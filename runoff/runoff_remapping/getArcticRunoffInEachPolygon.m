function totalRunoff=getArcticRunoffInEachPolygon(oriRunoff,myRunoffInfo)
...
if nargin==1
   if ischar(oriRunoff) 
      ...
      load coast_buffer_AHYPE_runoff.mat
      
      for nmon=1:nRec
           cRunoff=squeeze(runoffMonthlyFile(nmon,:,1)); 
           totalRunoff(nmon,:)=getArcticRunoffInEachPolygon(cRunoff,myRunoffInfo);
      end
...
%       end
      ...
      help getArcticRunoffInEachPolygon
      return
   end
elseif nargin~=2
   help getArcticRunoffInEachPolygon
