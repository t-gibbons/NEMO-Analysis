function createCombinedRunoffHBC_IA(baysys_code, baysys_conf, baysys_domn, YS, YE)
...
rnfDTpath=['IA/ANHA4_Calib_',baysys_code,'_Arctic_runoff_monthly_'];
rnfGL=['ANHA4_',baysys_conf,'_',baysys_code,'_',baysys_domn,'_runoff_monthly_y',num2str(YS),'_y',num2str(YE),'.nc'];
...
for ny=YS:YE
    ...
    saveFileName=['IA/ANHA4_',baysys_conf,'_',baysys_code,'_',baysys_domn,'_runoff_monthly_',tTag,'.nc'];
    [ncfid,varIDList]=createNC(saveFileName,NY,NX,varList,['HYPE ',baysys_conf,' runoff for ',baysys_code,' BaySys run for ',num2str(YS),' to ',num2str(YE),' (',date,')']);
