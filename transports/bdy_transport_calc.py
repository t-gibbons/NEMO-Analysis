...
bdy_path = '/project/6007519/weissgib/ANHA4x-I/BDY/'
bath_file = '/project/6007519/weissgib/ANHA4x-I/ANHA4x_bathy.nc'
grid_file = '/project/6007519/weissgib/ANHA4x-I/ANHA4x_mesh_mask.nc'
thickness_file = '/project/6007519/weissgib/plotting/data_files/anha4x_files/computed_u_thickness_anha4x.npy'
...
def calc_bdy_trans(year, direction):
    ...
    if direction == 'north':
        i = 910 #top boundary line
        j = 541 #how wide in the x direction?
    ...
    bdy_data = bdy_path+'ANHA4x_bdy_'+direction+'_updated_eORCA025-ETW510_y'+year+'.nc'
    ...
    #across the boundary we just account for the y velocity
...
def plot_bdy_transport():
    ...
    plt.title('Boundary Transport ANHA4x eORCA025 ETW510 2002')

    plt.savefig(fig_dir+'bdy_trans_eORCA025-ETW510_anha4x.png')
    #plt.show()
